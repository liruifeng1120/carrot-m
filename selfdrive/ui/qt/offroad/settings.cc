...
CarrotPanel::CarrotPanel(QWidget* parent) : QWidget(parent) {
  ...
  cruiseToggles->addItem(new CValueControl("CruiseSpeedUnit", tr("Button: Cruise Speed Unit"), tr(""), "../assets/offroad/icon_road.png", 1, 20, 1));
  ...
  pathToggles->addItem(new CValueControl("ShowPathModeCruiseOff", tr("DISP: Path Mode: Cruise OFFF"), tr("0:Normal,1,2:Rec,3,4:^^,5,6:Rec,7,8:^^,9,10,11,12:Smooth^^"), "../assets/offroad/icon_shell.png", 0, 15, 1));
  ...
  pathToggles->addItem(new CValueControl("ShowPathMode", tr("DISP:Path Mode: Laneless"), tr("0:Normal,1,2:Rec,3,4:^^,5,6:Rec,7,8:^^,9,10,11,12:Smooth^^", "../assets/offroad/icon_shell.png"), "../assets/offroad/icon_shell.png", 0, 15, 1));
  ...
  speedToggles->addItem(new CValueControl("AutoRoadSpeedAdjust", tr("Auto Roadlimit Speed adjust (50%)"), "", "../assets/offroad/icon_road.png", 0, 100, 10));
